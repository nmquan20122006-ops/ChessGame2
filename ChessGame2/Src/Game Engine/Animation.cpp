...
void TweenyAnimator::addMove(sf::Sprite sprite, sf::Vector2f start, sf::Vector2f end, int durationMs) {
    AnimData task;
    task.sprite = sprite;
    task.sprite.setPosition(start); // Đặt vị trí ban đầu ngay lập tức
