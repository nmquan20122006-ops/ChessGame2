...
void TextureManager::initTexture() {
	...
	loadTexture("PieceAtlas", "Assets/asset.png");
	loadTexture("BoardTexture", "Assets/Board.png");
	loadTexture("BorderTexture", "Assets/Border.png");
	loadTexture("BoardTexture2", "Assets/Board2.png");
	loadTexture("ChessSprite", "Assets/ChessSprite.png");
	loadTexture("Piecesprite", "Assets/Piecesprite.png");
	loadTexture("HighlightDot", "Assets/HighlightDot.png");
	loadTexture("CaptureRing", "Assets/CaptureRing.png");
